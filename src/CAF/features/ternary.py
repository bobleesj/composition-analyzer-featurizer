...
def generate_features(formula: str, db: dict) -> dict:
    R, M, X, index_R, index_M, index_X, index_R_norm, index_M_norm, index_X_norm = prepare_ternary_formula(formula)
    RMX = (R, M, X)
    ...
    features = {
        ...
        "atomic_weight_RMX_sum_weighted": RMX_sum_weighted(RMX, indices, P.AW, db),
        ...
        "atomic_number_RMX_avg_weighted": avg_weighted_RMX(RMX, indices, P.ATOMIC_NUMBER, db),
        ...
        "period_RMX_sum_weighted_norm": RMX_sum_weighted_norm(RMX, indices_norm, P.PERIOD, db),
        "period_RM_sum_weighted_norm": RM_sum_weighted_norm(R, M, indices_norm, P.PERIOD, db),
        "period_MX_sum_weighted_norm": MX_sum_weighted_norm(M, X, indices_norm, P.PERIOD, db),
        "period_RX_sum_weighted_norm": RX_sum_weighted_norm(R, X, indices_norm, P.PERIOD, db),
        # group - 10 features
        ...
        "group_RMX_sum_weighted_norm": RMX_sum_weighted_norm(RMX, indices_norm, P.GROUP, db),
        "group_RM_sum_weighted_norm": RM_sum_weighted_norm(R, M, indices_norm, P.GROUP, db),
        "group_MX_sum_weighted_norm": MX_sum_weighted_norm(M, X, indices_norm, P.GROUP, db),
        "group_RX_sum_weighted_norm": RX_sum_weighted_norm(R, X, indices_norm, P.GROUP, db),
        ...
        "Mendeleev_number_RMX_avg_weighted": avg_weighted_RMX(RMX, indices, P.MEND_NUM, db),
        ...
        "Mendeleev_number_RM_sum_weighted_norm": RM_sum_weighted_norm(R, M, indices_norm, P.MEND_NUM, db),
        "Mendeleev_number_MX_sum_weighted_norm": MX_sum_weighted_norm(M, X, indices_norm, P.MEND_NUM, db),
        "Mendeleev_number_RX_sum_weighted_norm": RX_sum_weighted_norm(R, X, indices_norm, P.MEND_NUM, db),
    }
        ...
        features.update(
            {
                ...
                f"{prop}_RMX_sum_weighted": RMX_sum_weighted(RMX, indices, prop, db),
                f"{prop}_RMX_sum_weighted_norm": RMX_sum_weighted_norm(RMX, indices_norm, prop, db),
                f"{prop}_RM_sum_weighted_norm": RM_sum_weighted_norm(R, M, indices_norm, prop, db),
                f"{prop}_MX_sum_weighted_norm": MX_sum_weighted_norm(M, X, indices_norm, prop, db),
                f"{prop}_RX_sum_weighted_norm": RX_sum_weighted_norm(R, X, indices_norm, prop, db),
            }
        )
