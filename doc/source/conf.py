...
# -*- coding: utf-8 -*-
#
# composition-analyzer-featurizer documentation build configuration file, created by
...
try:
    fullversion = version("composition-analyzer-featurizer")
except Exception:
...
# abbreviations
ab_authors = "Sangjoon Lee, Emil Jaffal, Danila Shiryaev, Nikhil Kumar Barua, Alex Vtorov, Anton Oliynyk"
...
project = "Composition Analyzer/Featurizer (CAF)"
...
modindex_common_prefix = ["composition-analyzer-featurizer"]
...
html_context = {
    ...
    "github_repo": "composition-analyzer-featurizer",
    "github_version": "main",
...
basename = "composition-analyzer-featurizer".replace(" ", "").replace(".", "")
...
latex_documents = [
    (
        "index",
        "composition-analyzer-featurizer.tex",
        "composition-analyzer-featurizer Documentation",
        ab_authors,
        "manual",
    ),
]
